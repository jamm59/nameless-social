...
function FloatingNavigationBar() {
  return (
    <View className="absolute bottom-8 left-0 right-0 flex flex-row items-center justify-around">
      <View className="w-[93%] flex-row items-center justify-around rounded-[2rem] bg-white py-3">
        <NavIcon Icon={User} label="Feed" active />
        <NavIcon Icon={Scroll} label="Stories" />
        <NavIcon Icon={Search} label="Search" />
        <NavIcon Icon={Megaphone} label="Ads" />
        <NavIcon Icon={Users} label="Recommended" />
      </View>
      {/* <*/}
    </View>
  );
